 ...
 */
final class Version20210607095417 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fiche_financiere ADD ma_id_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fiche_financiere DROP ma_id_id');
    }
}
