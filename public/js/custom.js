...
$(document).ready(function(){
	...
	$('.ripple-effect1, .ripple-effect-dark1').on('click', function(e) {
		var rippleDiv = $('<span class="ripple-overlay">'),
			rippleOffset = $(this).offset(),
			rippleY = e.pageY - rippleOffset.top,
			rippleX = e.pageX - rippleOffset.left;
	...
	$('.ripple-effect2, .ripple-effect-dark2').on('click', function(e) {
		var rippleDiv = $('<span class="ripple-overlay">'),
			rippleOffset = $(this).offset(),
			rippleY = e.pageY - rippleOffset.top,
			rippleX = e.pageX - rippleOffset.left;
  ...
  /* global ClipboardJS */
	...
	function _populateFileField1($button1) {
	    ...
	    uploadButton1.$nameField1.html(selectedFile1);
	}
	/*** */
	var uploadButton2 = {
		$button2    : $('.uploadButton-input2'),
		$nameField2 : $('.uploadButton-file-name2')
	};

	uploadButton2.$button2.on('change',function() {
		_populateFileField2($(this));
	});

	function _populateFileField2($button2) {
		var selectedFile2 = [];
	    for (var i = 0; i < $button2.get(0).files.length; ++i) {
	        selectedFile2.push($button2.get(0).files[i].name +'<br>');
	    }
	    uploadButton2.$nameField2.html(selectedFile2);
	}
	/*** */
